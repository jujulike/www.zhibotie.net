...
class page{
	...
	public function getUrl(){   
		$url = '/apps.php?'.http_build_query($_GET);
	...
	public function getPage(){
		...
		if($this->page!=1){
            $pagestr .= "<a href=\"{$url}p=".($this->page-1)."\" data-role=\"button\" data-inline=\"true\" data-icon=\"arrow-r\" data-iconpos=\"right\">上一页</a>";
		}
...
//		}
		if($this->page!=$this->pagenum){
			$pagestr .= "<a href=\"{$url}p=".($this->page+1)."\" data-role=\"button\" data-inline=\"true\" data-icon=\"arrow-r\" data-iconpos=\"right\">下一页</a>";
		}
		/*if($this->page+5<$this->pagenum){
			$pagestr.="<a href=".$url."p=".$this->pagenum.">尾页</a> ";
		}
        */
        $pagestr .= "&nbsp;页次 ".$this->page."/".$this->pagenum;
		return $pagestr;	
	}
